...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <form id="form12" name="form12" method="post" action="">
            <input type="submit" name="editService" id="editService" value=  "       Edit       " />
            <input type="submit" name="addNewService" id="addNewService" value="       Add        " />
            <input type="submit" name="deleteService" id="deleteService" value="      Delete      " />
        </form>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
