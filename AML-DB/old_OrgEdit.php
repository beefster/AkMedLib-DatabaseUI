...
<html>
    ...
    <nav>
        ...
        <!--TODO: High-level navigation-->


        <!--Navigate within Organizations pages-->
        ...
        <fieldset>
            ...
            <div id ="top">
                <fieldset>
                    ...
                    Name: <input type="text" name="Org_Name" width="wide"/><br />
                ...
                <fieldset>
                    ...
                    Address <input label="Address" type="text" name="Physical_Address_Line_1" /><br />
