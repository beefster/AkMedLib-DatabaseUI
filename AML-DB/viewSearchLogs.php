...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <! Submit buttons - eventually move to more suitable location >
        <p>
            <input type="submit" name="editSearchLog" id="editSearchLog" value=  "       Edit       " />
            <input type="submit" name="addNewSearchLog" id="addNewSearchLog" value="       Add        " />
            <input type="submit" name="deleteSearchLog" id="deleteSearchLog" value="      Delete      " />
        </p>
    </body>
</html>
