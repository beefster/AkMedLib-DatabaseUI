...
<form id="form12" name="form12" method="post" action="">
  <input type="submit" name="EditService" id="EditService" value="Edit Organization" />
  <input type="submit" name="DeleteService" id="DeleteService" value="Delete Organization" />
  <input type="submit" name="addNewService" id="addNewService" value="Add New Organization" />
</form>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
